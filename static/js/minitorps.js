    ...
    $("#search-form").submit(function(e) {
        ...
        $.get($log.data("buscar-sesion-url"), params, function (resp) {
            ...
            if(resp.position == -1) {
                ...
                var texto-encontrado = '<span class="texto-encontrado">' + params["texto"] + '</span>';
                ...
                resp.content = contenido_antes + texto-encontrado + contenido_despues;
    ...
    function actualizar() {
        ...
        $.ajax({
            ...
            success: function(resp){
                $("#monitorps").find(".contenido_principal  ").html(resp);
            }
        });
    }
